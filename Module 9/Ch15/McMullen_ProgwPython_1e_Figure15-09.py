...
# Options stored in a list for random choice later
...
for car_on_lot in dealer.inventory:
    if car_on_lot.make == search_car.make and \
       car_on_lot.model == search_car.model and \
       car_on_lot.color == search_car.color and \
       car_on_lot.year == search_car.year:
